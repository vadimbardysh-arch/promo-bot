...
> 🔴 **ВАЖЛИВО! Перед кожним новим запуском:**
> 1. **Видали заклади** з попереднього запуску в акаунті Food Partner Portal (через Admin Panel)
> 2. **Заміни CSV файл** `venues.csv` на новий — з актуальним списком партнерів для поточного запуску
>
> Якщо цього не зробити, скрипт додасть нових партнерів до старих, і промо підключаться на всіх — і нових, і старих!
